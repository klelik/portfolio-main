...
const showData = projectsData.map((project, index) => {
  ...
  <div class="flex justify-center transform transition ease-in-out duration-1000 hover:scale-105 hover:rotate-[360deg]">
    ...
    <div>
    <a href = "${project.git}" target="_blank">      <button type="button" class="btn text-white bg-[#68B7DE] hover:bg-[#79BFE2]/80  font-medium rounded text-sm px-5 py-2.5 text-center inline-flex items-center   mr-2 mb-2">
    ...
    <a href = "${project.deploy}" target="_blank">      <button type="button" class="btn text-white bg-[#68B7DE] hover:bg-[#79BFE2]/90  font-medium rounded text-sm px-5 py-2.5 text-center inline-flex items-center   mr-2 mb-2">
    <svg  class="mr-2 -ml-1 w-4 h-4" xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 24 24" fill="none" stroke="#ffffff" stroke-width="2.5" stroke-linecap="butt" stroke-linejoin="round"><path d="M4 11a9 9 0 0 1 9 9"></path><path d="M4 4a16 16 0 0 1 16 16"></path><circle cx="5" cy="19" r="1"></circle></svg>   Preview
  </button></a>
